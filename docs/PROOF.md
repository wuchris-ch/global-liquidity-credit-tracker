...
| 12 | Calculation correctness is **tested** | [`tests/`](../tests) - 170+ offline unit tests over published formulas and evidence controls; gated in CI before any publish ([`ci.yml`](../.github/workflows/ci.yml), [`update-data.yml`](../.github/workflows/update-data.yml)) | `make test` |
