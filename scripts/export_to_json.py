...
REQUIRED_PRODUCTION_EXPORT_PATHS = (
    ...
    "api/series/ecb_total_assets/index.json",
    "api/series/ecb_total_assets/latest/index.json",
    "api/series/boj_total_assets/index.json",
    "api/series/boj_total_assets/latest/index.json",
    ...
    "api/series/sp500_price/index.json",
    "api/series/sp500_price/latest/index.json",
